      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='#319795' onClick={onOpen} color="white"
            _hover={{ background: "teal", color:"teal.400" }} _active={{ background: "teal", color:"teal.400" }}>
        ...
        <div>
          <Menu>
            ...
            <MenuList bg = "teal" borderColor="black" borderWidth="2px" pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="#319795"  rightIcon={<ChevronDownIcon/>}  
              _hover={{background: "teal", color:"teal.400"}} _active={{background: "teal", color:"teal.400"}}>
              <Avatar size="sm" cursor="pointer" name={user.name} borderColor="white" borderWidth="2px" bg="teal.400" color="white"/>
            </MenuButton>
            <MenuList bg = "teal.600" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="white" _hover={{background: "teal.400"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="bold" color="white" onClick={logoutHandler} _hover={{background: "teal.400"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
